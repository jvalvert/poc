...
void TestMessageWithCustomOptions::SharedCtor() {
  _cached_size_ = 0;
  field1_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyString());
...
void TestMessageWithCustomOptions::SharedDtor() {
  if (field1_ != &::google::protobuf::internal::GetEmptyString()) {
    delete field1_;
  }
...
void AggregateMessageSetElement::SharedCtor() {
  _cached_size_ = 0;
  s_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyString());
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
}
...
void AggregateMessageSetElement::SharedDtor() {
  if (s_ != &::google::protobuf::internal::GetEmptyString()) {
    delete s_;
  }
  if (this != default_instance_) {
  }
