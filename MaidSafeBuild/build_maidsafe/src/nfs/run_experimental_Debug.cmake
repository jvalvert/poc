...
set(CTEST_BUILD_NAME "Nfs ${CTEST_CONFIGURATION_TYPE} OSX10.10${MachineBuildType}, ${CMAKE_CXX_COMPILER_ID} ${CMAKE_CXX_COMPILER_VERSION}")

set_property(GLOBAL PROPERTY SubProject Nfs)
set_property(GLOBAL PROPERTY Label Nfs;)
...
ctest_build(TARGET AllNfs RETURN_VALUE ReturnCode NUMBER_ERRORS ErrorCount)
if(NOT ReturnCode EQUAL "0" OR NOT ErrorCount EQUAL "0")
  ctest_submit(RETRY_COUNT 3 RETRY_DELAY 5)
  return()
endif()
ctest_test(INCLUDE_LABEL Nfs$)
ctest_submit(RETRY_COUNT 3 RETRY_DELAY 5)
