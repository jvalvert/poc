...
set(CTEST_BUILD_NAME "Vault ${CTEST_CONFIGURATION_TYPE} OSX10.10${MachineBuildType}, ${CMAKE_CXX_COMPILER_ID} ${CMAKE_CXX_COMPILER_VERSION}")

set_property(GLOBAL PROPERTY SubProject Vault)
set_property(GLOBAL PROPERTY Label Vault;)
...
ctest_build(TARGET AllVault RETURN_VALUE ReturnCode NUMBER_ERRORS ErrorCount)
if(NOT ReturnCode EQUAL "0" OR NOT ErrorCount EQUAL "0")
  ctest_submit(RETRY_COUNT 3 RETRY_DELAY 5)
  return()
endif()
ctest_test(INCLUDE_LABEL Vault$)
ctest_submit(RETRY_COUNT 3 RETRY_DELAY 5)
