...
set(CTEST_BUILD_NAME "VaultManager ${CTEST_CONFIGURATION_TYPE} OSX10.10${MachineBuildType}, ${CMAKE_CXX_COMPILER_ID} ${CMAKE_CXX_COMPILER_VERSION}")

set_property(GLOBAL PROPERTY SubProject VaultManager)
set_property(GLOBAL PROPERTY Label VaultManager;)
...
ctest_build(TARGET AllVaultManager RETURN_VALUE ReturnCode NUMBER_ERRORS ErrorCount)
if(NOT ReturnCode EQUAL "0" OR NOT ErrorCount EQUAL "0")
  ctest_submit(RETRY_COUNT 3 RETRY_DELAY 5)
  return()
endif()
ctest_test(INCLUDE_LABEL VaultManager$)
ctest_submit(RETRY_COUNT 3 RETRY_DELAY 5)
